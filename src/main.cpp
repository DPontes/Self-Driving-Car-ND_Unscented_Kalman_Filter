    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Reset RMSE if timestamp reset (restart dataset) or
        ...
        /*
          ...
          In case of using only one measurement type ans the first measurement
          is the other sensor type, the state x will be Initialized as all zero
        */
        if(!ukf.x_.isZero()){
        ...
        // Calculate RMSE of accumulated state estimations vs ground_truth
